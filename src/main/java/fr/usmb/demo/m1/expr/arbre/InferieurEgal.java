...
public class InferieurEgal implements Noeud {
    ...
    public String genererCode() {
        ...
        sb.append("\t jle vrai_jle_").append(id).append("\n");
        sb.append("\t mov eax, 0\n");
        sb.append("\t jmp fin_jle_").append(id).append("\n");
        sb.append("vrai_jle_").append(id).append(":\n");
        sb.append("\t mov eax, 1\n");
        sb.append("fin_jle_").append(id).append(":\n");
        return sb.toString();
    }
