...
public class Egalite implements Noeud {
    private Noeud gauche;
    private Noeud droite;

    public Egalite(Noeud gauche, Noeud droite) {
        this.gauche = gauche;
        this.droite = droite;
    }
    ...
    public String genererCode() {
        ...
        // sub ebx, eax met le flag ZF si gauche == droite
        ...
        sb.append("\t mov eax, 1\n");
        sb.append("fin_je_").append(id).append(":\n");
        return sb.toString();
    }
